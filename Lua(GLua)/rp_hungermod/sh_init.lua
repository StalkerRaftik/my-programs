...
rp.Foods = {}
rp.FoodsIcons = {}
function rp.AddFoodItem(name, mdl, amount, weight, class, thirst, icon, isAlcohol)
	rp.Foods[#rp.Foods + 1] = {name = name, model = mdl, amount = amount or 0, weight = weight or 1, class = class, thirst = thirst or 0, icon = icon or "samprp/moreicons/food_meal2.png", isAlcohol = isAlcohol or false }
